...
import { Provider, JsonRpcProvider, JsonRpcSigner, TransactionRequest } from '@ethersproject/providers';
 ...
 */
declare class PoolsSubgraphOnChainRepository implements Findable<Pool, PoolAttribute>, Searchable<Pool> {
...
interface PoolFactory {
    create(parameters: ComposableStableCreatePoolParameters | WeightedCreatePoolParameters): TransactionRequest;
